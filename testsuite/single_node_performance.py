...
EXPECTED_TPS = {
    ...
    ("token-v1ft-mint-and-transfer", False, 20): (6000.0, False),
    ("token-v1nft-mint-and-transfer-sequential", False, 1): (1100.0, True),
    ("token-v1nft-mint-and-transfer-sequential", False, 20): (4000.0, False),
    ...
    ("token-v2-ambassador-mint", False, 1): (5000.0, False),
...
with tempfile.TemporaryDirectory() as tmpdirname:
    ...
    for (transaction_type, use_native_executor, module_working_set_size), (
        ...
        print(
            f"grep_single_node_perf,{transaction_type},{module_working_set_size},{use_native_executor_row_str},{cur_block_size},{expected_tps},{tps},{gps}"
        )
